# EDD Eval Console — static site (GitHub Pages)

A zero-backend, client-side build of the [web console](../app.py). It tells the
same story as the live harness — **one job · one verdict · one record** — but
